...
lightbox.prototype = {
	...
	displayLightbox: function(display){
		...
		if(display != 'none') this.loadInfo2();
	},
	...
	loadInfo2: function() {
       ...
       if (this.id != null) {
           this.cloneWindowContents(this.id);
       }
	},
    ...
    cloneWindowContents: function(id) {
        ...
        //new Insertion.Before($('lbLoadMessage'), content);
...
function initialize(){
	...
	for(i = 0; i < lbox.length; i++) {
		valid = new lightbox(lbox[i], null);
	}
}
...
function show_lightbox(id) {
    active_lightbox = new lightbox(null, id);
    active_lightbox.activate();
    return false;
}

function hide_lightbox() {
    active_lightbox.deactivate();
    return false;
}