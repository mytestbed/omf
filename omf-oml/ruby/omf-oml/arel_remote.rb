...
module OMF::OML
  ...
  # This module provides support to query an OML repository through the OMF-AM +result+
  # service API.
  #
  # While there should be a much more comprehensive documentation on how to use this, see
  # the bottom of this file for a few smaples.
  #
  module Arel
...
if $0 == __FILE__
  include OMF::OML::Arel
  
  adaptor = HttpServiceAdaptor.new('http://localhost:5053/result2/query') 
  opts = {:name => 'test'}
  repo = Repository.new(opts, adaptor)
